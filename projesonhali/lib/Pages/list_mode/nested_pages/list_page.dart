        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: GridView.count(
                ...
                children: <Widget>[
                  _buildCard('Cookie mint', 'images/cleaning/cif.png',
                      false, false, context),
                  _buildCard('Cookie cream', 'images/cleaning/bulasıkdeterjan.jpg',
                      true, false, context),
                  _buildCard('Cookie classic',
                      'images/cleaning/yumossprey.jpg', false, true, context),
                  _buildCard('Cookie choco', 'images/cleaning/sleepy.png',
                      false, false, context)
                ],
              )),
        ...
        child: InkWell(
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => list_detail(
                      assetPath: imgPath,
                      cookiename: name
                  )));
            },
